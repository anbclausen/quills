(define (domain Quantum)
    ...
    (:action advance_d0
        :precondition (clock d0)
        :effect (and (not (busy l0)) (not (busy l1)) (not (busy l2)) (not (busy l3)) (clock d1) (not (clock d0)))
    )

    (:action advance_d1
        :precondition (clock d1)
        :effect (and (not (busy l0)) (not (busy l1)) (not (busy l2)) (not (busy l3)) (clock d2) (not (clock d1)))
    )

    (:action advance_d2
        :precondition (clock d2)
        :effect (and (not (busy l0)) (not (busy l1)) (not (busy l2)) (not (busy l3)) (clock d3) (not (clock d2)))
    )

    (:action advance_d3
        :precondition (clock d3)
        :effect (and (not (busy l0)) (not (busy l1)) (not (busy l2)) (not (busy l3)) (clock d4) (not (clock d3)))
    )
