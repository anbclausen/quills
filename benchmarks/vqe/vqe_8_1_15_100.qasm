...
cx q[3],q[7];
cx q[6],q[3];
u(12.316370614359172,pi/2 - pi/2,pi/2) q[6];
cx q[7],q[6];
...
cx q[6],q[3];
u(pi/2,pi/2 - pi/2,pi/2 + pi/2) q[3];
cx q[3],q[0];
...
cx q[6],q[5];
cx q[5],q[0];
u(pi/2,-pi/2,1.0 + pi/2) q[0];
cx q[3],q[0];
cx q[5],q[1];
u(pi/2,-pi/2,pi/2) q[5];
cx q[3],q[5];
u(11.566370614359174,-pi/2,pi/2 + pi) q[3];
...
u(0,-pi/2,pi/2 + 10.4247779607694) q[7];
cx q[7],q[4];
u(pi/2,pi/2 - pi/2,pi/2) q[7];
cx q[7],q[0];
cx q[7],q[5];
u(6.033185307179587,pi/2 - pi/2,pi/2) q[7];
cx q[0],q[7];
...
cx q[1],q[7];
u(1.0,-pi/2,pi/2) q[1];
u(3*pi/2,-pi/2,pi/2 + 4.14159265358979) q[7];
cx q[1],q[7];
u(pi/2,pi/2 - pi/2,pi/2) q[1];
