...
from pddl import PDDLInstance, PDDLAction, PDDLPredicate, PDDLType, object_, not_
...
class PlanningSynthesizer(Synthesizer):
    def create_instance(
        ...
        occupied = PDDLPredicate[pqubit]
        mapped = PDDLPredicate[tuple[lqubit, pqubit]]
        connected = PDDLPredicate[tuple[pqubit, pqubit]]
        done = PDDLPredicate[gate]
        clock = PDDLPredicate[tuple[pqubit, depth]]
        next_depth = PDDLPredicate[tuple[depth, depth]]
        next_swap_depth = PDDLPredicate[tuple[depth, depth]]
        is_swapping1 = PDDLPredicate[tuple[pqubit, pqubit]]
        is_swapping2 = PDDLPredicate[tuple[pqubit, pqubit]]
        is_swapping = PDDLPredicate[pqubit]
